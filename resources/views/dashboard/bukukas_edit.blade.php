            ...
            <div class="col-12">
              <form class="form-label-left input_mask" action="{{url('/dashboard/bukukas_update')}}" method="post">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    ...
                    <select id="role" class="form-control" required name="proyek">
                      @foreach($proyek as $p)
                      <option value="{{$p->id}}" @if($bukukas->proyek === $p->id) selected @endif>{{$p->nama}}</option>
                      @endforeach
                    </select>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <input type="date" class="form-control" placeholder="Masukkan Kode Proyek" name="tanggal" value={{$bukukas->tanggal}}>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <textarea name="keterangan" class="form-control" placeholder="Masukkan Keterangan" id="" cols="30" rows="3">{{$bukukas->keterangan}}</textarea>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <select id="role" class="form-control" required name="kategori">
                      ...
                      <option value="{{$k->id}}" @if($bukukas->kategori === $k->id) selected @endif>{{$k->nama}}</option>
                      @endforeach
                    </select>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <input type="text" class="form-control" placeholder="Masukkan No Bukti" name="bukti" value="{{$bukukas->no_bukti ?? ''}}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <input type="number" class="form-control" placeholder="Masukkan Uang Masuk" name="masuk" value={{$bukukas->masuk ?? ''}}>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <input type="number" class="form-control" placeholder="Masukkan Uang Keluar" name="keluar" value={{$bukukas->keluar ?? ''}}>
