    ...
    <div class="row">
      <div class="col-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <div class="col-12">
              <form class="form-label-left input_mask" action="{{ url('/dashboard/daftar_tukang_aksi') }}" method="post">
                @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <input name="alamat" class="form-control" placeholder="Masukkan Alamat Tukang" value="{{ old('alamat') }}">
                    @error('alamat')
                      <small>*{{ $message }}</small>
                    @enderror
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <select name="mandor" class="form-control" id="">
                      ...
                      @foreach ($mandor as $m)
                        <option value={{ $m->id }} @if (old('mandor') == $m->id) selected @endif>
                          {{ $m->nama }}</option>
                      @endforeach
                    </select>
                    <small>
