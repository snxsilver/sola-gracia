              ...
              <form class="form-label-left input_mask" action="{{url('/dashboard/invoice_aksi')}}" method="post">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <input type="date" class="form-control" placeholder="Masukkan Tanggal Invoice" name="tanggal" value={{now()}}>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <input type="text" class="form-control" placeholder="Masukkan Nama Perusahaan" name="perusahaan">
